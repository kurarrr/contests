...
long long pow2ceil(long long n) { --n; n |= n >> 32; n |= n >> 16; n |= n >> 8; n |= n >> 4; n |= n >> 2; n |= n >> 1; return n + 1;}
long long lg2ceil(long long n){return __builtin_popcount(pow2ceil(n)-1);}
long long lg2floor(long long n) { n |= n >> 32; n |= n >> 16; n |= n >> 8; n |= n >> 4; n |= n >> 2; n |= n >> 1; return __builtin_popcount(n)-1;}
...
void _main(){
  ...
  rep(i,t){
    ll N; cin >> N ;
    dump(lg2floor(N));
    cout << N*(N+1)/2 - 2LL*((1LL<<(lg2floor(N)+1))-1) << endl;
  }
}